...
Dir.mktmpdir("dora-change-impact") do |root|
  alpha = {"kind" => "dora_change_impact", "version" => 1, "rules" => [{"id" => "api", "path_prefixes" => ["api/"], "validations" => ["api-test"], "documentation" => ["docs/api.md"], "runtime_evidence" => ["runtime/api"], "decisions" => ["API-1"]}]}
