...
report = Dora::PluginReport.build!(plugin_id: "alpha-check", inputs: {"roots" => ["src"]}, findings: [{"id" => "alpha", "status" => "passed"}])
...
begin
  Dora::PluginReport.build!(plugin_id: "bad id", inputs: {}, findings: [])
