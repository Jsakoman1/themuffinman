...
.detail-utility-rail__trust { margin: 0; padding: var(--space-2) var(--space-3); border-bottom: 1px solid var(--border-subtle); color: var(--text-soft); font-size: var(--text-size-meta); line-height: 1.45; }
</style>
