...
<template>
  <div ref="fieldRoot" class="app-form-field" data-archetype="progressive-form-field" :class="{'app-form-field--invalid': Boolean(props.error)}">
...
.app-form-field{padding-block:var(--space-1)}
</style>
