...
<style scoped>
.universal-create-menu{position:relative}.universal-create-menu__summary{cursor:pointer;list-style:none;padding:var(--space-1) var(--space-2);border:1px solid var(--accent);border-radius:var(--radius-control);background:var(--accent);color:var(--canvas);font-size:var(--text-size-body);font-weight:var(--text-weight-semibold)}.universal-create-menu__summary::-webkit-details-marker{display:none}.universal-create-menu__panel{position:absolute;right:0;top:calc(100% + var(--space-2));z-index:var(--z-popover);display:grid;gap:var(--space-2);width:min(24rem,calc(100vw - 2rem));padding:var(--space-3);border:1px solid var(--border-strong);border-radius:var(--radius-surface);background:var(--surface-raised);box-shadow:var(--shadow-overlay)}.universal-create-menu__panel p{margin:var(--space-1) 0;color:var(--text-muted);font-size:var(--text-size-body)}.universal-create-menu__option{display:grid;gap:var(--space-1);padding:var(--space-2);border-radius:var(--radius-control)}.universal-create-menu__option:hover{background:var(--surface-hover)}.universal-create-menu__option span{color:var(--text-muted);font-size:var(--text-size-meta)}.universal-create-menu__error{color:var(--danger)}@media(max-width:640px){.universal-create-menu__panel{position:fixed;right:var(--space-3);top:4.5rem}}
</style>
