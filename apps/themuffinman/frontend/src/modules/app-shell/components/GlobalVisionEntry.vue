...
<style scoped>
.global-vision-entry{position:relative}.global-vision-entry__summary{cursor:pointer;list-style:none;padding:.7rem .85rem;border:1px solid rgba(23,34,26,.12);border-radius:999px;background:rgba(23,34,26,.96);color:#f8f8f4;font-weight:650}.global-vision-entry__summary::-webkit-details-marker{display:none}.global-vision-entry__panel{position:absolute;right:0;top:calc(100% + .55rem);z-index:20;display:grid;gap:.75rem;width:min(28rem,calc(100vw - 2rem));padding:1rem;border:1px solid rgba(23,34,26,.12);border-radius:1rem;background:#fcfcf8;box-shadow:0 18px 38px rgba(23,34,26,.16)}.global-vision-entry__panel p{margin:.25rem 0 0;color:rgba(23,34,26,.62);font-size:.82rem}.global-vision-entry__composer{display:grid;grid-template-columns:minmax(0,1fr) auto auto;gap:.4rem}.global-vision-entry__composer input,.global-vision-entry__composer button{min-width:0;border:1px solid rgba(23,34,26,.14);border-radius:.7rem;padding:.6rem .7rem;font:inherit}.global-vision-entry__composer button{cursor:pointer;background:#17221a;color:#f8f8f4;font-size:.8rem;font-weight:650}.global-vision-entry__composer .global-vision-entry__mic{background:rgba(214,228,218,.8);color:#17221a}.global-vision-entry__error{color:#8d2f25!important}@media(max-width:640px){.global-vision-entry__panel{position:fixed;right:1rem;top:4.5rem}.global-vision-entry__composer{grid-template-columns:1fr 1fr}.global-vision-entry__composer input{grid-column:1/-1}}
</style>
