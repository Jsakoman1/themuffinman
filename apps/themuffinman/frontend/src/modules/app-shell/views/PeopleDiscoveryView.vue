...
<style scoped>.people-discovery{display:grid;gap:1rem;max-width:58rem}.people-discovery header{display:flex;justify-content:space-between;align-items:end;gap:1rem}.eyebrow{margin:0 0 .3rem;color:rgba(23,34,26,.55);font-size:.76rem;font-weight:650;letter-spacing:.08em;text-transform:uppercase}h1{margin:0;font-size:clamp(1.7rem,3vw,2.6rem);letter-spacing:-.075em}.intro{color:rgba(23,34,26,.62)}.search{display:flex;gap:.5rem;max-width:42rem}.search input{flex:1;border:1px solid rgba(23,34,26,.14);border-radius:.7rem;padding:.7rem;font:inherit}.primary,.secondary,.search button{display:inline-flex;align-items:center;justify-content:center;border:1px solid rgba(23,34,26,.14);border-radius:999px;padding:.55rem .8rem;font:inherit;font-size:.8rem;font-weight:650}.primary,.search button{background:#17221a;color:#f8f8f4}.results{display:grid;gap:.4rem}.result{display:flex;justify-content:space-between;align-items:center;gap:1rem;padding:1rem;border:1px solid rgba(23,34,26,.08);border-radius:.9rem;background:rgba(255,255,255,.62)}.result p,.result span{display:block;margin:.25rem 0 0;color:rgba(23,34,26,.6);font-size:.84rem}.actions{display:flex;gap:.4rem;flex-wrap:wrap}.status{color:rgba(23,34,26,.62)}.status--error{color:#8d2f25}.status button{margin-left:.5rem;border:0;background:none;color:inherit;text-decoration:underline}@media(max-width:620px){.people-discovery header,.result{align-items:start;flex-direction:column}.search{max-width:none;width:100%}}</style>
