...
.business-profile__gallery{display:grid;gap:.8rem;padding-top:1rem;border-top:1px solid rgba(23,34,26,.1)}.business-profile__gallery h2{margin:0}.business-profile__gallery header p{margin:.25rem 0 0;color:rgba(23,34,26,.6);font-size:.85rem}.business-profile__gallery-form{display:grid;grid-template-columns:2fr 1.3fr .6fr auto;gap:.5rem;align-items:end}.business-profile__gallery-form label{display:grid;gap:.3rem;font-size:.78rem;font-weight:650}.business-profile__gallery-form input{border:1px solid rgba(23,34,26,.14);border-radius:.6rem;padding:.55rem;font:inherit}.business-profile__gallery-form button,.business-profile__gallery-item button{border:1px solid rgba(23,34,26,.12);border-radius:999px;padding:.5rem .7rem;background:#17221a;color:#f8f8f4;font:inherit;cursor:pointer}.business-profile__gallery-form button:disabled,.business-profile__gallery-item button:disabled{opacity:.5;cursor:wait}.business-profile__gallery-list{display:grid;grid-template-columns:repeat(3,1fr);gap:.7rem}.business-profile__gallery-item{display:grid;gap:.4rem}.business-profile__gallery-item img{width:100%;aspect-ratio:4/3;object-fit:cover;border-radius:.7rem;background:rgba(23,34,26,.06)}.business-profile__gallery-item div{display:flex;gap:.3rem;align-items:center;flex-wrap:wrap}.business-profile__gallery-item span{flex:1;color:rgba(23,34,26,.58);font-size:.75rem}.business-profile__gallery-item button{padding:.35rem .55rem;background:transparent;color:#17221a;font-size:.75rem}@media(max-width:700px){.business-profile__gallery-form{grid-template-columns:1fr 1fr}.business-profile__gallery-form label:first-child{grid-column:1/-1}.business-profile__gallery-list{grid-template-columns:1fr 1fr}}
.business-profile__switcher{display:flex;align-items:end;gap:.6rem}.business-profile__switcher label{display:grid;gap:.3rem;font-size:.8rem;font-weight:650;flex:1}.business-profile__switcher select{border:1px solid rgba(23,34,26,.14);border-radius:.65rem;padding:.6rem;background:white;font:inherit}.business-profile__switcher button{border:1px solid rgba(23,34,26,.12);border-radius:999px;padding:.6rem .8rem;background:#17221a;color:#f8f8f4;font:inherit;cursor:pointer}
.business-profile__actions{display:flex;gap:.55rem;align-items:center}.business-profile__archive{border:1px solid rgba(141,47,37,.3);border-radius:999px;padding:.6rem .8rem;background:transparent;color:#8d2f25;font:inherit;cursor:pointer}
</style>
