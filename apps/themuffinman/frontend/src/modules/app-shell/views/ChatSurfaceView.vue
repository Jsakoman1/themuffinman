...
<template>
  <section class="chat-surface">
    ...
    <form v-if="groupTitle !== '' || participantQuery !== ''" class="chat-surface__group-create" @submit.prevent="createGroup">
      ...
      <AppFormField label="Participants" hint="Choose people from your permitted Circle context."><input v-model="participantQuery" placeholder="Find people" aria-label="Find people" @input="searchParticipants"></AppFormField>
    ...
    <div class="chat-surface__layout">
      ...
      <aside v-if="selectedConversation" class="chat-surface__context" aria-label="Conversation context">
        ...
        <p class="chat-surface__context-note">Conversation actions and sync status stay server-authoritative.</p>
      </aside>
