...
.chat-surface__related--context{display:grid;gap:var(--space-1);padding:var(--space-2) var(--space-3);border:1px solid var(--border-subtle);border-radius:var(--radius-surface);background:var(--surface-raised);color:var(--text-muted);font-size:var(--text-size-meta)}.chat-surface__related--context strong{color:var(--text)}.chat-surface__related--context a{justify-self:start;color:var(--accent);font-weight:var(--text-weight-semibold)}
