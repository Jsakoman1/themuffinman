...
<template>
  <section class="quest-applications">
    ...
    <template v-else-if="view">
      ...
      <div class="quest-applications__summary"><span>{{ view.pendingApplicationCount }} pending · {{ view.hiddenApplicationsCount }} hidden</span><span class="quest-applications__hint">{{ actionHint }}</span><AppButton v-if="view.canRevealHiddenApplications" type="button" tone="quiet" @click="load(!view.showingAllApplications)">{{ view.revealLabel }}</AppButton></div>
