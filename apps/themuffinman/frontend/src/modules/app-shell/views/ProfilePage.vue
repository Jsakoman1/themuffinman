...
<template>
  <section class="profile-page" aria-label="Profile and settings" data-navigation-model="sibling-tabs" data-mental-model="summary-select-edit-save">
    ...
    <section v-if="activeId === 'profile'" class="profile-summary" aria-labelledby="profile-summary-title" data-profile-first-view="identity-privacy-next-action">
