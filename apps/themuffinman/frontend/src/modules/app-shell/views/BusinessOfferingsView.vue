...
<style scoped>
.offerings-surface{display:grid;gap:1rem;max-width:52rem}.offerings-surface__header{display:flex;justify-content:space-between;align-items:end;gap:1rem}.offerings-surface__eyebrow{margin:0 0 .3rem;color:var(--text-muted);font-size:.76rem;font-weight:650;letter-spacing:.08em;text-transform:uppercase}h1{margin:0;font-size:clamp(1.55rem,2.5vw,2.3rem);letter-spacing:-.075em}h2{margin:0;font-size:1.1rem}.offerings-surface__list{display:grid;gap:.45rem}.offerings-surface__row{display:flex;justify-content:space-between;gap:1rem;align-items:center;padding:.85rem 0;border:1px solid var(--border-subtle)}.offerings-surface__row>div:first-child{display:grid;gap:.28rem;min-width:0}.offerings-surface__row span{color:var(--text-muted);font-size:.84rem}.offerings-surface__actions{display:flex;gap:.35rem}.offerings-surface button{border:1px solid var(--border-subtle);border-radius:999px;padding:.45rem .75rem;background:transparent;font:inherit;font-size:.82rem;font-weight:650;cursor:pointer;white-space:nowrap}.offerings-surface__primary{border:0!important;background:var(--accent)!important;color:var(--text)}.offerings-surface__danger{color:var(--danger)}.offerings-surface__secondary{margin-left:.4rem}.offerings-surface__form{display:grid;gap:.75rem;border:1px solid var(--border-subtle);padding-top:1rem}.offerings-surface__form label{display:grid;gap:.35rem;font-size:.83rem;font-weight:650;color:var(--text-muted)}.offerings-surface__form input,.offerings-surface__form textarea{border:1px solid var(--border-subtle);border-radius:.65rem;padding:.65rem;background:var(--surface);font:inherit;font-weight:400}.offerings-surface__form textarea{min-height:6rem}.offerings-surface__grid{display:grid;grid-template-columns:repeat(3,1fr);gap:.7rem}.offerings-surface__toggle{display:flex!important;align-items:center;gap:.5rem!important}.offerings-surface__toggle input{width:auto}.offerings-surface__feedback{margin:0;color:var(--success)}.offerings-surface__status{padding:.7rem 0;color:var(--text-muted)}.offerings-surface__status--error{color:var(--danger)}.offerings-surface__status button{margin-left:.5rem;border:0;background:none;color:inherit;text-decoration:underline}@media(max-width:620px){.offerings-surface__row{align-items:start;flex-direction:column}.offerings-surface__grid{grid-template-columns:1fr}}
</style>
