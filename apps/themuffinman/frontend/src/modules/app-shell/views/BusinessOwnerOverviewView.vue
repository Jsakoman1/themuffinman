...
<style scoped>
.business-owner-overview{display:grid;gap:var(--space-4)}.business-owner-overview__attention{display:flex;justify-content:space-between;gap:var(--space-3);padding:var(--space-3);border:1px solid var(--accent);border-radius:var(--radius-surface);background:var(--accent-muted);color:var(--text);text-decoration:none}.business-owner-overview__attention span{color:var(--accent);font-size:var(--text-size-meta);font-weight:var(--text-weight-semibold)}.business-owner-overview__setup{display:grid;gap:var(--space-3);padding:var(--space-4);border:1px solid var(--border-subtle);border-radius:var(--radius-surface);background:var(--surface-raised);color:var(--text)}.business-owner-overview__setup>div{display:grid;gap:var(--space-1)}.business-owner-overview__setup h2,.business-owner-overview__setup p{margin:0}.business-owner-overview__setup>div>p:last-child,.business-owner-overview__setup small{color:var(--text-muted)}.business-owner-overview__eyebrow{color:var(--text-muted);font-size:var(--text-size-label);font-weight:var(--text-weight-semibold);letter-spacing:var(--tracking-label);text-transform:uppercase}.business-owner-overview__setup ol{display:grid;gap:var(--space-2);margin:0;padding:0;list-style:none}.business-owner-overview__setup li{display:grid;grid-template-columns:auto minmax(0,1fr) auto;align-items:center;gap:var(--space-2);padding:var(--space-2);border-top:1px solid var(--border-subtle)}.business-owner-overview__setup li>span{display:grid;place-items:center;width:1.6rem;height:1.6rem;border:1px solid var(--border);border-radius:50%;font-size:var(--text-size-meta);font-weight:var(--text-weight-semibold)}.business-owner-overview__setup li.complete>span{border-color:var(--success);background:var(--success-muted);color:var(--success)}.business-owner-overview__setup li div{display:grid;gap:2px}.business-owner-overview__setup a{color:var(--accent);font-size:var(--text-size-meta);font-weight:var(--text-weight-semibold)}.business-owner-overview__summary{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:var(--space-2)}.business-owner-overview__summary a{display:grid;gap:var(--space-1);padding:var(--space-3);border:1px solid var(--border-subtle);border-radius:var(--radius-card);background:var(--surface-raised);color:var(--text);text-decoration:none}.business-owner-overview__summary a:hover{transform:translateY(-1px);border-color:var(--border)}.business-owner-overview__summary strong{font-size:var(--text-size-title)}.business-owner-overview__summary span{color:var(--text-muted);font-size:var(--text-size-meta)}.business-owner-overview__list{overflow:hidden;border:1px solid var(--border-subtle);border-radius:var(--radius-surface);background:var(--surface-base)}.business-owner-overview__list :deep(.surface-row:last-child){border-bottom:0}@media(max-width:700px){.business-owner-overview__setup li{grid-template-columns:auto minmax(0,1fr)}.business-owner-overview__setup li>a{grid-column:2}.business-owner-overview__summary{grid-template-columns:repeat(2,minmax(0,1fr))}}
</style>
