...
<style scoped>
.quest-create{display:grid;gap:1rem}.quest-create__header{display:flex;justify-content:space-between;align-items:end;gap:1rem}.quest-create__eyebrow{margin:0 0 .3rem;color:var(--text-muted);font-size:.76rem;font-weight:650;letter-spacing:.08em;text-transform:uppercase}h1{margin:0;font-size:clamp(1.55rem,2.5vw,2.3rem);letter-spacing:-.075em}.quest-create__vision,.quest-create__actions a,.quest-create__actions button{display:inline-flex;align-items:center;justify-content:center;min-height:2.3rem;border:1px solid var(--border-subtle);border-radius:999px;padding:.45rem .8rem;font-size:.82rem;font-weight:650;background:transparent}.quest-create__vision,.quest-create__actions button{background:var(--accent);color:var(--text)}.quest-create__form{display:grid;gap:.85rem;max-width:44rem;padding:1rem;border:1px solid var(--border-subtle);border-radius:1rem;background:var(--surface)}.quest-create__draft-boundary{margin:0;color:var(--text-muted);font-size:.82rem}.quest-create__form label{display:grid;gap:.3rem;font-size:.82rem;font-weight:650}.quest-create__form input,.quest-create__form textarea{width:100%;border:1px solid var(--border-subtle);border-radius:.7rem;padding:.7rem;font:inherit}.quest-create__form textarea{min-height:10rem;resize:vertical}.quest-create__actions{display:flex;justify-content:flex-end;gap:.45rem}.quest-create__error{margin:0;color:var(--danger)}@media(max-width:700px){.quest-create__header{align-items:start;flex-direction:column}}
</style>
