...
<style scoped>
.notification-preferences{display:grid;gap:1rem;max-width:44rem}.eyebrow{margin:0 0 .3rem;color:var(--text-muted);font-size:.76rem;font-weight:650;letter-spacing:.08em;text-transform:uppercase}h1{margin:0;font-size:clamp(1.55rem,2.5vw,2.3rem);letter-spacing:-.075em}.intro{max-width:38rem;color:var(--text-muted)}form{display:grid;gap:1rem;padding:1rem;border:1px solid var(--border-subtle);border-radius:1rem;background:var(--surface)}fieldset{display:grid;gap:.55rem;border:0;padding:0;margin:0}legend{font-weight:700;margin-bottom:.15rem}.option{display:flex;align-items:center;gap:.6rem;font-weight:550}.option input{width:1rem;height:1rem}.option span{display:flex;gap:.5rem;align-items:center}.option small{color:var(--text-muted);font-size:.72rem}.save,.status button{justify-self:start;border:1px solid var(--border-subtle);border-radius:999px;padding:.6rem .85rem;background:var(--accent);color:var(--text);font:inherit;font-weight:650;cursor:pointer}.save:disabled{opacity:.55}.feedback{margin:0;color:var(--success)}.status{padding:.7rem 0;color:var(--text-muted)}.status--error{color:var(--danger)}.status button{margin-left:.5rem;background:transparent;color:inherit;text-decoration:underline}
</style>
