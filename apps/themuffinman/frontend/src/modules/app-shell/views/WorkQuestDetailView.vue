  ...
  <section class="quest-detail">
    ...
    <template v-else-if="detail">
      ...
      <DetailSurface v-if="!editing" title="Quest detail" utility-label="Quest actions" class="quest-detail__layout">
        <RichTextPreview :content="detail.quest.description" /><section class="quest-detail__activity"><h2>Current facts</h2><dl><div v-for="item in detail.activityRail" :key="item.label"><dt>{{ item.label }}</dt><dd>{{ item.value }}</dd></div></dl></section>
