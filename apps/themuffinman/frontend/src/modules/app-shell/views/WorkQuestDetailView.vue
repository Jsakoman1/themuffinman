  ...
  <section class="quest-detail">
    ...
    <template v-else-if="detail">
      ...
      <div v-if="!editing" class="quest-detail__layout">
        <main class="quest-detail__main"><RichTextPreview :content="detail.quest.description" /><div class="quest-detail__facts"><span>{{ detail.quest.awardAmount }} €</span><span>{{ detail.quest.presentation.statusLabel }}</span><span>{{ detail.quest.presentation.timeTypeLabel }}</span><span>{{ detail.quest.presentation.locationLabel || "Anywhere" }}</span></div></main>
...
<style scoped>
.quest-detail__application{display:grid;gap:.8rem;max-width:44rem;border:1px solid rgba(23,34,26,.08);border-radius:1rem;background:rgba(255,255,255,.62);padding:1rem}.quest-detail__application h2{margin:0;font-size:1.05rem}.quest-detail__application label{display:grid;gap:.3rem;font-size:.82rem;font-weight:650}.quest-detail__application textarea,.quest-detail__application input{width:100%;border:1px solid rgba(23,34,26,.14);border-radius:.7rem;padding:.7rem;font:inherit}.quest-detail__application textarea{min-height:8rem;resize:vertical}.quest-detail__application-help{margin:0;color:rgba(23,34,26,.6);font-size:.82rem}
</style>
