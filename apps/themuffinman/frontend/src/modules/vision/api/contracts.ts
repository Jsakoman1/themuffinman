import type {QuestApplicationStatus} from "../domain/visionDomain.ts"
...
export type AdminAgentExecutionRequest = import("../../../contracts/index.ts").AdminAgentExecutionRequest
export type AdminAgentExecutionResponse = import("../../../contracts/index.ts").AdminAgentExecutionResponse
...
export type QuestSearchRequest = Partial<import("../../../contracts/index.ts").QuestSearchRequestDTO> & {
  sort?: import("../domain/visionDomain.ts").QuestSortMode
}
