...
export const createQuestDashboardStateModules = (
  ...
  const interactions = createDashboardInteractions({
    ...
    adminModeEnabled,
    activeTab: tabState.activeTab,
    overviewFocus: questState.overviewFocus,
    profileUsername: profileState.profileUsername,
    profileDescription: profileState.profileDescription,
    profileAvatarDataUrl: profileState.profileAvatarDataUrl,
    isProfileEditDialogOpen: profileState.isProfileEditDialogOpen,
