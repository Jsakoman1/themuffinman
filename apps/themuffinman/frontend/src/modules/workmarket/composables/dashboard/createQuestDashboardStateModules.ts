...
export const createQuestDashboardStateModules = (
  ...
  const interactions = createDashboardInteractions({
    ...
    editQuestAssigneeTarget: questState.editQuestAssigneeTarget,
    editQuestShowApprovedApplicants: questState.editQuestShowApprovedApplicants,
    ...
    questAssigneeTarget: questState.questAssigneeTarget,
    questShowApprovedApplicants: questState.questShowApprovedApplicants,
