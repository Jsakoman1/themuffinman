...
import type {ActionResult, AppUser, AppUserRequest, UserProfileView, WorkmarketOptions} from "../contracts.ts"
...
export const usersApi = {
  ...
  async getAppUserOptions(): Promise<WorkmarketOptions> {
    return (await api.get<WorkmarketOptions>("/app_users/options", withAuth())).data
  },
