...
<template>
  <UiAppShellPage page-class="chat-page" eyebrow="Shared Chat" title="Conversations">
    <UiRequestError
      v-if="errorMessage"
    ...
    <UiWorkspace variant="detail">
      ...
      <UiSurfaceSection title="Recent" subtitle="Current accepted-contact conversations">
      ...
      <UiSurfaceSection title="People" subtitle="Accepted circle contacts">
