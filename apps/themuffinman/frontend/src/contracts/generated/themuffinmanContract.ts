...
export const STATUS_VALUES = ["PENDING", "PROCESSING", "FAILED", "DELIVERED"] as const
...
export const WORKMARKET_QUEST_APPLICATION_NEWS_EVENT_TYPE_VALUES = ["CREATED", "UPDATED", "WITHDRAWN", "APPROVED", "DECLINED"] as const
export type WorkmarketQuestApplicationNewsEventType = typeof WORKMARKET_QUEST_APPLICATION_NEWS_EVENT_TYPE_VALUES[number]
...
export const AGENT_REQUIRED_UNRESOLVED_INPUTS = ["application_id", "application_query", "assignment_mode", "audio_clip", "authenticated_user", "availability_exception_id", "availability_exception_payload", "availability_rule_id", "availability_rule_payload", "base_email", "booking_id", "booking_payload", "booking_policy_payload", "business_name", "business_slug", "circle_id", "circle_name", "circle_query", "conversation_id", "conversation_query", "decision", "departure_at", "description", "destination", "destructive_confirmation", "email", "emoji", "explicit_confirmation", "file", "from", "gallery_image_payload", "image_id", "latitude", "listing_id", "location_mode", "longitude", "message", "message_body", "message_id", "name", "news_id", "news_query", "offering_id", "offering_payload", "origin", "other_user_id", "owner_booking_payload", "owner_user", "participant_user_id", "participant_user_ids", "password", "preset", "prompt", "prompt_text", "quest_count", "quest_id", "quest_payload", "quest_payload_template", "quest_query", "quest_templates", "recipient_id", "recipient_query", "replacement_application_id", "request_id", "requester_time_zone", "reviewed_user_id", "reward_amount", "role", "scheduled_at", "scheduling_request", "selected_people", "slug", "stars", "storage_key", "text_prompt", "title", "to", "user_id", "user_query", "username", "worker_application_id", "worker_quest_id"] as const
