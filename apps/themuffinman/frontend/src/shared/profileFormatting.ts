...
export const formatUserRatingSummary = (summary: RatingSummary) => {
  return summary.reviewCount ? `${summary.averageStars.toFixed(1)} / 5` : "No reviews"
}

export const formatReviewedRoleLabel = (reviewedRole: string) => {
  return reviewedRole === "EMPLOYER" ? "As employer" : "As worker"
}
