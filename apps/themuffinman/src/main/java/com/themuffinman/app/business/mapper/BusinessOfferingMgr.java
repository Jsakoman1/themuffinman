...
public class BusinessOfferingMgr {
    ...
    public BusinessOfferingResponseDTO toDto(BusinessOffering offering) {
        ...
        return BusinessOfferingResponseDTO.builder()
                ...
                .fulfillmentMode(offering.getFulfillmentMode())
                .schemaVersion(offering.getSchemaVersion())
                .durationIncrementMinutes(offering.getDurationIncrementMinutes())
                .minimumQuantity(offering.getMinimumQuantity())
                .maximumQuantity(offering.getMaximumQuantity())
