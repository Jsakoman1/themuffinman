...
public class QuestService {
    ...
    public com.themuffinman.app.workmarket.dto.QuestListResponseDTO searchQuests(
            AppUser currentUser,
            String query,
            com.themuffinman.app.workmarket.model.QuestStatus status,
            com.themuffinman.app.workmarket.model.QuestAudience audience,
    ...
    public com.themuffinman.app.workmarket.dto.QuestListResponseDTO getQuestListPreset(
            com.themuffinman.app.workmarket.dto.QuestListPresetDTO preset,
            AppUser currentUser,
            String query,
            com.themuffinman.app.workmarket.model.QuestAudience audience,
            java.time.LocalDate dateFrom,
    ...
    public com.themuffinman.app.workmarket.dto.QuestDetailResponseDTO getQuestDetailResponseById(Long id, AppUser currentUser) {
        return questReadService.getQuestDetailResponseById(id, currentUser);
    }

    public com.themuffinman.app.workmarket.dto.QuestApplicationDetailResponseDTO getApplicationDetailResponseById(Long applicationId, AppUser currentUser) {
