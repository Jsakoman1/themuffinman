...
public class DashboardSectionsFactory {
    ...
    private List<com.themuffinman.app.vision.dto.DashboardQuestGroupDTO> buildQuestGroups(List<QuestResponseDTO> quests) {
        return List.of(
    ...
    private List<com.themuffinman.app.vision.dto.DashboardApplicationGroupDTO> buildApplicationGroups(List<QuestApplicationResponseDTO> applications) {
        return List.of(
    ...
    private com.themuffinman.app.vision.dto.DashboardQuestGroupDTO buildQuestGroup(
            String statusKey,
            String tone,
        ...
        return com.themuffinman.app.vision.dto.DashboardQuestGroupDTO.builder()
                .key(statusKey)
                .label(label)
                .tone(tone)
                .count(items.size())
    ...
    private com.themuffinman.app.vision.dto.DashboardApplicationGroupDTO buildApplicationGroup(
            String statusKey,
            String tone,
        ...
        return com.themuffinman.app.vision.dto.DashboardApplicationGroupDTO.builder()
                .key(statusKey)
                .label(label)
                .tone(tone)
                .count(items.size())
