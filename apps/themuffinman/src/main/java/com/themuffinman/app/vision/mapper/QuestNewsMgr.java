    ...
    public QuestNewsItemResponseDTO toDto(QuestNewsItem item) {
        ...
        if (item.getApplicationId() != null) {
            ...
            navigation = NavigationTargetDTO.builder()
                    ...
                    .build();
        } else if (item.getType() == com.themuffinman.app.vision.model.QuestNewsType.CIRCLE_REQUEST_RECEIVED
                || item.getType() == com.themuffinman.app.vision.model.QuestNewsType.CIRCLE_REQUEST_ACCEPTED) {
            navigation = NavigationTargetDTO.builder()
        ...
        return QuestNewsItemResponseDTO.builder()
                ...
                .canAcceptCircleRequest(item.getType() == com.themuffinman.app.vision.model.QuestNewsType.CIRCLE_REQUEST_RECEIVED && item.getCircleRequestId() != null)
                .canDeclineCircleRequest(item.getType() == com.themuffinman.app.vision.model.QuestNewsType.CIRCLE_REQUEST_RECEIVED && item.getCircleRequestId() != null)
