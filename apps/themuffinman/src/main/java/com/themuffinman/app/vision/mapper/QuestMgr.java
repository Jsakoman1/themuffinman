...
import com.themuffinman.app.vision.service.QuestPresentationAssembler;
...
public class QuestMgr {
    ...
    public Quest toEntity(QuestRequestDTO dto, AppUser creator) {
        ...
        quest.setAudience(dto.getAudience() == null ? com.themuffinman.app.vision.model.QuestAudience.CIRCLES : dto.getAudience());
