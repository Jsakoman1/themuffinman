...
Owns reusable backend helpers that are intentionally domain-neutral: pagination, validation, normalization, errors, DTO primitives, and shared service utilities.
