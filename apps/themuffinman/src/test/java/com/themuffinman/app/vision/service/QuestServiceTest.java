...
class QuestServiceTest {
    ...
    private VisionPresentationHelper visionPresentationHelper;
    ...
    void getQuestDetailResponseByIdReturnsQuestMyApplicationAndVisibleApplications() {
        ...
        when(questApplicationService.getApplicationsViewForQuest(33L, currentUser, false)).thenReturn(
                com.themuffinman.app.vision.dto.QuestApplicationsViewDTO.builder()
    ...
    void confirmQuestTermChangeAppliesPendingTermForApprovedApplicant() {
        ...
        com.themuffinman.app.vision.model.QuestApplication approvedApplication = new com.themuffinman.app.vision.model.QuestApplication();
        approvedApplication.setId(22L);

        when(questRepository.findForQuestDetail(16L)).thenReturn(Optional.of(quest));
        when(questApplicationRepository.findForViewerApplicationWithStatus(16L, 2L, com.themuffinman.app.vision.model.QuestApplicationStatus.APPROVED))
                .thenReturn(Optional.of(approvedApplication));
        when(questRepository.save(quest)).thenReturn(quest);
    ...
    void rejectQuestTermChangeRestoresPreviousStatusForApprovedApplicant() {
        ...
        when(questApplicationRepository.findForViewerApplicationWithStatus(17L, 2L, com.themuffinman.app.vision.model.QuestApplicationStatus.APPROVED))
                .thenReturn(Optional.of(approvedApplication));
        when(questRepository.save(quest)).thenReturn(quest);
