...
- `/vision` now also gives direct chat prompts a short list of candidate people when the name fragment is ambiguous, instead of failing with a generic "could not identify" message.
