...
- `/vision` detail continuity is routed through Vision-native quest and application entry points before legacy detail pages are deleted, because preserving the read/action bridge in the new surface makes the decommission path safer.
