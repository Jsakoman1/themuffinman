...
- `{:file: "apps/themuffinman/src/main/java/com/themuffinman/app/workmarket/service/QuestApplicationAdminService.java", :kind: "service", :lines: 118, :public_methods: 2, :responsibility_markers: ["query", "mutation", "policy"], :flags: ["mixed_responsibilities"]}`
- `{:file: "apps/themuffinman/src/main/java/com/themuffinman/app/workmarket/service/QuestApplicationService.java", :kind: "service", :lines: 113, :public_methods: 15, :responsibility_markers: ["query", "mutation"], :flags: ["many_public_methods"]}`
