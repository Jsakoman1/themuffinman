...
- `{:file: "apps/themuffinman/frontend/src/modules/business/views/BusinessHubView.vue", :uses_feedback_runner: false, :uses_run_with_feedback: false, :has_after_success: false, :refresh_calls: ["loadBusinessHub"]}`
...
- `{:file: "apps/themuffinman/frontend/src/modules/chat/views/ChatWorkspaceView.vue", :uses_feedback_runner: false, :uses_run_with_feedback: false, :has_after_success: false, :refresh_calls: ["loadWorkspace"]}`
- `{:file: "apps/themuffinman/frontend/src/modules/rides/views/RideSharingView.vue", :uses_feedback_runner: false, :uses_run_with_feedback: false, :has_after_success: false, :refresh_calls: ["loadRides"]}`
...
- `{:file: "apps/themuffinman/frontend/src/modules/things/views/ThingSharingView.vue", :uses_feedback_runner: false, :uses_run_with_feedback: false, :has_after_success: false, :refresh_calls: ["loadThings"]}`
