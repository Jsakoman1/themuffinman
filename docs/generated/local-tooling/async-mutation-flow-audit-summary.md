...
- `{:file: "apps/themuffinman/frontend/src/services/sessionService.ts", :uses_feedback_runner: false, :uses_run_with_feedback: false, :has_after_success: false, :refresh_calls: ["loadToken", "loadUser"]}`
