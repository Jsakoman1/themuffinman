...
- `{:pattern: "lazy_init_risk", :file: "apps/themuffinman/src/main/java/com/themuffinman/app/business/model/BusinessProfile.java", :line: 30, :snippet: "@ManyToOne(fetch = FetchType.LAZY, optional = false)"}`
