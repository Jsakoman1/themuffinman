# Endpoint Contract Pack rides

- Generated At: `2026-06-29T12:47:29Z`
- Endpoint Family: `rides`
## `endpoints`

- `{:method: "GET", :path: "/rides/offers", :controller: "apps/themuffinman/src/main/java/com/themuffinman/app/rides/controller/RideOfferController.java", :dtos: ["RideOfferListResponseDTO", "RideOfferResponseDTO", "RideOfferRequestDTO"]}`
- `{:method: "POST", :path: "/rides/offers", :controller: "apps/themuffinman/src/main/java/com/themuffinman/app/rides/controller/RideOfferController.java", :dtos: ["RideOfferResponseDTO", "RideOfferRequestDTO"]}`
- `{:method: "GET", :path: "/rides/offers/me", :controller: "apps/themuffinman/src/main/java/com/themuffinman/app/rides/controller/RideOfferController.java", :dtos: ["RideOfferListResponseDTO", "RideOfferResponseDTO", "RideOfferRequestDTO"]}`

## `dto_files`

- `apps/themuffinman/src/main/java/com/themuffinman/app/rides/dto/RideOfferListResponseDTO.java`
- `apps/themuffinman/src/main/java/com/themuffinman/app/rides/dto/RideOfferRequestDTO.java`
- `apps/themuffinman/src/main/java/com/themuffinman/app/rides/dto/RideOfferResponseDTO.java`
