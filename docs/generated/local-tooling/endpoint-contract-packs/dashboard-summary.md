...
- `{:method: "GET", :path: "/dashboard/me", :controller: "apps/themuffinman/src/main/java/com/themuffinman/app/workmarket/controller/DashboardController.java", :dtos: ["DashboardResponseDTO", "DashboardSummaryDTO"]}`
- `{:method: "GET", :path: "/dashboard/me/summary", :controller: "apps/themuffinman/src/main/java/com/themuffinman/app/workmarket/controller/DashboardController.java", :dtos: ["DashboardResponseDTO", "DashboardSummaryDTO"]}`

## `dto_files`

- `apps/themuffinman/src/main/java/com/themuffinman/app/workmarket/dto/DashboardResponseDTO.java`
- `apps/themuffinman/src/main/java/com/themuffinman/app/workmarket/dto/DashboardSummaryDTO.java`
...
- `{:file: "apps/themuffinman/frontend/src/components/app/AppNotificationsPanel.vue", :matched_paths: ["me", "summary"]}`
...
- `{:file: "apps/themuffinman/frontend/src/components/app/topbar/useTopbarNotifications.ts", :matched_paths: ["me", "summary"]}`
...
- `{:file: "apps/themuffinman/frontend/src/components/profile/ProfileSummaryCard.vue", :matched_paths: ["me", "summary"]}`
