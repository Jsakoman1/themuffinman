...
- `{:path: "apps/themuffinman/src/main/java/com/themuffinman/app/workmarket/service/ApplyForQuestUseCase.java", :category: "backend_service", :domain: "workmarket", :lines: 34}`
- `{:path: "apps/themuffinman/src/main/java/com/themuffinman/app/workmarket/service/ApproveApplicationUseCase.java", :category: "backend_service", :domain: "workmarket", :lines: 75}`
...
- `{:path: "apps/themuffinman/src/main/java/com/themuffinman/app/workmarket/controller/DashboardController.java", :category: "backend_controller", :domain: "workmarket", :lines: 29}`
- `{:path: "apps/themuffinman/src/main/java/com/themuffinman/app/workmarket/controller/QuestApplicationController.java", :category: "backend_controller", :domain: "workmarket", :lines: 135}`
- `{:path: "apps/themuffinman/src/main/java/com/themuffinman/app/workmarket/controller/QuestController.java", :category: "backend_controller", :domain: "workmarket", :lines: 130}`
- `{:path: "apps/themuffinman/src/main/java/com/themuffinman/app/workmarket/controller/QuestNewsController.java", :category: "backend_controller", :domain: "workmarket", :lines: 51}`
- `{:path: "apps/themuffinman/src/main/java/com/themuffinman/app/workmarket/controller/UserReviewController.java", :category: "backend_controller", :domain: "workmarket", :lines: 25}`

## `key_repositories`

- `{:path: "apps/themuffinman/src/main/java/com/themuffinman/app/workmarket/repository/QuestApplicationRepository.java", :category: "backend_repository", :domain: "workmarket", :lines: 82}`
- `{:path: "apps/themuffinman/src/main/java/com/themuffinman/app/workmarket/repository/QuestNewsRepository.java", :category: "backend_repository", :domain: "workmarket", :lines: 28}`
- `{:path: "apps/themuffinman/src/main/java/com/themuffinman/app/workmarket/repository/QuestRepository.java", :category: "backend_repository", :domain: "workmarket", :lines: 67}`
- `{:path: "apps/themuffinman/src/main/java/com/themuffinman/app/workmarket/repository/UserReviewRepository.java", :category: "backend_repository", :domain: "workmarket", :lines: 38}`

## `key_models`

- `{:path: "apps/themuffinman/src/main/java/com/themuffinman/app/workmarket/model/Quest.java", :category: "backend_model", :domain: "workmarket", :lines: 139}`
- `{:path: "apps/themuffinman/src/main/java/com/themuffinman/app/workmarket/model/QuestApplication.java", :category: "backend_model", :domain: "workmarket", :lines: 41}`
- `{:path: "apps/themuffinman/src/main/java/com/themuffinman/app/workmarket/model/QuestApplicationStatus.java", :category: "backend_model", :domain: "workmarket", :lines: 16}`
- `{:path: "apps/themuffinman/src/main/java/com/themuffinman/app/workmarket/model/QuestAudience.java", :category: "backend_model", :domain: "workmarket", :lines: 6}`
- `{:path: "apps/themuffinman/src/main/java/com/themuffinman/app/workmarket/model/QuestNewsItem.java", :category: "backend_model", :domain: "workmarket", :lines: 55}`
- `{:path: "apps/themuffinman/src/main/java/com/themuffinman/app/workmarket/model/QuestNewsType.java", :category: "backend_model", :domain: "workmarket", :lines: 18}`
- `{:path: "apps/themuffinman/src/main/java/com/themuffinman/app/workmarket/model/QuestStatus.java", :category: "backend_model", :domain: "workmarket", :lines: 26}`
- `{:path: "apps/themuffinman/src/main/java/com/themuffinman/app/workmarket/model/ReviewRole.java", :category: "backend_model", :domain: "workmarket", :lines: 6}`
...
- `{:path: "apps/themuffinman/frontend/src/modules/workmarket/api/adminAgentContractGate.ts", :category: "frontend_api", :domain: "workmarket", :lines: 144}`
- `{:path: "apps/themuffinman/frontend/src/modules/workmarket/api/adminAgentSafetyViewModel.ts", :category: "frontend_api", :domain: "workmarket", :lines: 130}`
- `{:path: "apps/themuffinman/frontend/src/modules/workmarket/api/agentWorkflowGuards.ts", :category: "frontend_api", :domain: "workmarket", :lines: 76}`
- `{:path: "apps/themuffinman/frontend/src/modules/workmarket/api/clients/adminApi.ts", :category: "frontend_api", :domain: "workmarket", :lines: 59}`
- `{:path: "apps/themuffinman/frontend/src/modules/workmarket/api/clients/applicationsApi.ts", :category: "frontend_api", :domain: "workmarket", :lines: 64}`
- `{:path: "apps/themuffinman/frontend/src/modules/workmarket/api/clients/circlesApi.ts", :category: "frontend_api", :domain: "workmarket", :lines: 146}`
- `{:path: "apps/themuffinman/frontend/src/modules/workmarket/api/clients/dashboardApi.ts", :category: "frontend_api", :domain: "workmarket", :lines: 12}`
- `{:path: "apps/themuffinman/frontend/src/modules/workmarket/api/clients/locationApi.ts", :category: "frontend_api", :domain: "workmarket", :lines: 16}`
- `{:path: "apps/themuffinman/frontend/src/modules/workmarket/api/clients/newsApi.ts", :category: "frontend_api", :domain: "workmarket", :lines: 20}`
- `{:path: "apps/themuffinman/frontend/src/modules/workmarket/api/clients/questsApi.ts", :category: "frontend_api", :domain: "workmarket", :lines: 59}`
- `{:path: "apps/themuffinman/frontend/src/modules/workmarket/api/clients/usersApi.ts", :category: "frontend_api", :domain: "workmarket", :lines: 46}`
- `{:path: "apps/themuffinman/frontend/src/modules/workmarket/api/contracts.ts", :category: "frontend_api", :domain: "workmarket", :lines: 104}`

## `workflows`

- `{:id: "quest_lifecycle", :owner: "QuestStateTransitionService", :states: 6, :transitions: 10}`
- `{:id: "quest_application_lifecycle", :owner: "QuestApplicationWorkflowSupport", :states: 4, :transitions: 6}`
...
- `{:id: "workmarket-quest-lifecycle", :risk: "high", :scenario: "Quest create, update, delete, start, complete, and term-change flows must resolve actors, validate state, persist changes, and publish expected notifications.", :test_files: ["apps/themuffinman/src/test/java/com/themuffinman/app/workmarket/service/QuestUseCaseContractTest.java", "apps/themuffinman/src/test/java/com/themuffinman/app/workmarket/service/QuestWorkflowScenarioTest.java"], :commands: ["cd apps/themuffinman && ./mvnw test -Dtest=QuestUseCaseContractTest,QuestWorkflowScenarioTest"]}`
- `{:id: "workmarket-application-lifecycle", :risk: "high", :scenario: "Application apply, applicant edit, withdraw, owner approve, owner decline, and admin mutation flows must enforce ownership, status, pricing, and notification rules.", :test_files: ["apps/themuffinman/src/test/java/com/themuffinman/app/workmarket/service/QuestApplicationUseCaseContractTest.java", "apps/themuffinman/src/test/java/com/themuffinman/app/workmarket/service/QuestApplicationServiceTest.java"], :commands: ["cd apps/themuffinman && ./mvnw test -Dtest=QuestApplicationUseCaseContractTest,QuestApplicationServiceTest"]}`
- `{:id: "workmarket-dashboard-read-model", :risk: "medium", :scenario: "Dashboard sections, applicant actions, open-work groups, and notification destinations must stay backend-prepared and role-aware.", :test_files: ["apps/themuffinman/src/test/java/com/themuffinman/app/workmarket/service/DashboardServiceTest.java"], :commands: ["cd apps/themuffinman && ./mvnw test -Dtest=DashboardServiceTest"]}`
