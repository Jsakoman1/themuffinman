# AGENT-WORKMARKET-QUEST-DETAIL-DTO Plan

Source: `docs/agent-improvement-backlog.md`
Group: `agent-improvement`
Risk: `medium`
Master order: 27 of 82

## Backlog Item

Tighten workmarket quest-detail DTOs after the dashboard slice is stable.
...
- Backlog update: Removed `AGENT-WORKMARKET-QUEST-DETAIL-DTO` from `docs/agent-improvement-backlog.md` after adding quest-detail DTOs to strict source and documentation coverage.
